 ...
 */
class Application extends \Kevin\PlatformBundle\Entity\Application implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Application' . "\0" . 'id', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Application' . "\0" . 'author', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Application' . "\0" . 'content', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Application' . "\0" . 'date', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Application' . "\0" . 'advert'];
        }
