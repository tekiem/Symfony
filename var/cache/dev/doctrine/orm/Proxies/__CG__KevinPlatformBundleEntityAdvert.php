...
namespace Proxies\__CG__\Kevin\PlatformBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Advert extends \Kevin\PlatformBundle\Entity\Advert implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'id', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'date', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'title', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'author', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'content', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'published', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'applications', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'image', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'categories', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'updatedAt', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'nbApplications', '' . "\0" . 'Kevin\\PlatformBundle\\Entity\\Advert' . "\0" . 'slug'];
        }
