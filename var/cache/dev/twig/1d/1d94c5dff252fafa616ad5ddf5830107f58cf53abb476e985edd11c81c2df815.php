...
/* ::layout.html.twig */
class __TwigTemplate_7e839f293ccfa49697f06c4c1a10fa5d37c3451f262f9ad1ac85bb365d2b58a3 extends Twig_Template
{
...
<head>
    ...
    <title>{% block title %}Kevin Plateforme{% endblock %}</title>
...
<div class=\"container\">
    ...
    <div class=\"row\">
        <div id=\"menu\" class=\"col-md-3\">
            ...
            <h4>Dernières annonces</h4>
            {{ render(controller(\"KevinPlatformBundle:Advert:menu\", {'limit': 3})) }}
        </div>
        <div id=\"content\" class=\"col-md-9\">
            {% block body %}
            {% endblock %}
