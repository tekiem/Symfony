 ...
 * @ORM\Entity(repositoryClass="Kevin\PlatformBundle\Repository\ApplicationRepository")
...
class Application
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Kevin\PlatformBundle\Entity\Advert", inversedBy="applications")
